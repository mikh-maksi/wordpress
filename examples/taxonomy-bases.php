...
<div class="feature-header">
  <div class="feature-post-thumbnail">
    ...
    <div class="header-area">
      <h4 class="post-title feature-header-title">Трудова функція:</h1>

    <h1 class="post-title feature-header-title"><?php echo(esc_html($current_term->name)); ?></h1>
          ...
          <?php
            if ( have_posts() ) :
              ...
              while ( have_posts() ) :
                ...
                the_post();
                get_template_part( 'template-parts/content-bases', get_post_format() );
